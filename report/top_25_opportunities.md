# Top 25 Backlink Opportunities for Omni
...
|---|---|---|---|---|---|---|
| 1 | github.com | Sigma, Hex, Mode, Lightdash | Yes | 1.000 | 1.000 | Competitors are linked via popular repos/orgs/READMEs; ensure Omni's public repos, SDKs, and examples are easy to find and link back to omni.co. |
| 2 | github.io | Sigma, Hex, Mode, Lightdash | Yes | 1.000 | 1.000 | GitHub Pages' shared domain (many independent project/user sites, not one org); make sure any Omni docs, demos, or examples hosted on GitHub Pages link back to omni.co -- there is no single site to pitch here. |
| 3 | ycombinator.com | Sigma, Hex, Mode, Lightdash | Yes | 1.000 | 1.000 | Aggregates ycombinator.com and news.ycombinator.com (Hacker News); links likely come from HN discussion threads and/or the YC company directory -- engage authentically in relevant threads (e.g. Show HN, data-tooling posts) rather than pitching a single contact. |
...
Authority pct is each domain's harmonic-centrality rank in Common Crawl's domain-level web graph for a release, converted to a percentile of that release's domain count (2026-05: 118,760,321 domains, 2026-06: 121,091,933 domains) -- when a domain shows up in both releases, the higher of the two percentiles is kept. It measures how central a domain is in the overall link graph -- it is not Moz or Ahrefs Domain Authority; this pipeline uses neither.
